export const blogs = [
  {
    ...
    title:
      "Best CCNA Training Roadmap for Beginners in Hyderabad",

    seoTitle:
      "Best CCNA Training Roadmap for Beginners | CCNA Training in Hyderabad",

    seoDescription:
      "Learn the complete CCNA roadmap including subnetting, routing, switching, VLANs, OSPF and enterprise networking concepts for networking careers.",

    excerpt:
      "Learn how to start your networking career with CCNA certification, subnetting, routing, switching and practical Cisco networking labs.",

    image:
      "/blogs/ccna-roadmap.jpg",
...
`
...

  {
    ...
    title:
      "AWS Cloud Career Opportunities for Freshers",

    seoTitle:
      "AWS Cloud Career Opportunities | AWS Training in Hyderabad",

    seoDescription:
      "Explore AWS cloud career opportunities, cloud engineer roles, certifications and practical cloud skills required for cloud computing careers.",

    excerpt:
      "Discover why AWS cloud computing is creating high-demand career opportunities across startups and enterprise organizations.",

    image:
      "/blogs/aws-careers.jpg",
...
`
...

  {
    ...
    title:
      "Palo Alto Firewall vs Fortigate Firewall",

    seoTitle:
      "Palo Alto vs Fortigate Firewall Comparison",

    seoDescription:
      "Compare Palo Alto and Fortigate firewall technologies, security features and enterprise cyber security career opportunities.",

    excerpt:
      "Understand the differences between Palo Alto and Fortigate firewall technologies used in enterprise security environments.",

    image:
      "/blogs/paloalto-vs-fortigate.jpg",
...
`
...

  {
    ...
    seoTitle:
      "Network Engineer Interview Preparation Guide",

    seoDescription:
      "Learn how to prepare for networking interviews including subnetting, routing, switching and troubleshooting concepts.",

    excerpt:
      "Practical networking interview preparation strategies for CCNA and enterprise networking roles.",

    image:
      "/blogs/network-interview.jpg",
...
`
  ...
  {
    slug: "f5-load-balancer-career-scope",
    ...
    title:
      "F5 Load Balancer Career Scope & Enterprise Demand",

    seoTitle:
      "F5 Load Balancer Career Scope | F5 Training in Hyderabad",

    seoDescription:
      "Learn about F5 BIG-IP load balancing technologies, enterprise infrastructure demand and infrastructure engineering careers.",

    excerpt:
      "Explore enterprise application delivery, load balancing technologies and F5 infrastructure engineering opportunities.",

    image:
      "/blogs/f5-load-balancer.jpg",
