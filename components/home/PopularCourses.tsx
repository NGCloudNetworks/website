...
const courses = [
  {
    ...
    description:
      "Master subnetting, routing, switching and enterprise infrastructure with practical Cisco labs.",
    icon: Network,
    students: "5000+",
...

  {
    ...
    description:
      "Advanced enterprise routing, BGP, OSPF and scalable infrastructure implementation.",
    icon: Server,
    students: "2500+",
    level: "Advanced",
  },
...

  {
    ...
    description:
      "Hands-on firewall security, VPNs, threat prevention and enterprise protection training.",
    icon: ShieldCheck,
    students: "1800+",
  ...
  return (
    <section className="relative overflow-hidden py-24 lg:py-28">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[-140px] right-[-140px] h-[430px] w-[430px] rounded-full bg-[#D4AF37]/5 blur-[120px]" />

        <div className="absolute bottom-[-160px] left-[-140px] h-[420px] w-[420px] rounded-full bg-[#D4AF37]/5 blur-[120px]" />
          ...
          <div className="max-w-[860px]">
            ...
            >
              ...
              <span className="text-sm font-medium text-[#f5e6b3]">
                Industry-Focused Enterprise Programs
              </span>
            ...
            <p
              ...
              "
            >
              Build real-world enterprise skills through hands-on
              labs, practical troubleshooting, certification guidance
              and placement-oriented mentorship designed for modern
              IT infrastructure careers.
            </p>
