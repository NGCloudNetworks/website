...
const relatedCourses = [
  { title: "CCNA Training Hyderabad", href: "/courses/ccna-training-hyderabad" },
...
export default function ContactPageClient() {
    ...
    return (
        <main className="overflow-hidden bg-[#050505] text-white">
            ...
            {/* SEO / AEO CONTENT — direct-answer paragraph for crawlers & AI engines */}
            <section className="sr-only">
                <h1>
                    NG Cloud Networks - Best Networking, Cloud & Cyber Security Training Institute in Hyderabad
                </h1>
                <p>
                    NG Cloud Networks is located in Ameenpur, Hyderabad, Telangana,
                    and can be reached at +91 9989939191 or
                    info@ngcloudnetworks.com. The institute offers CCNA, CCNP
                    Enterprise, AWS Cloud, Azure Cloud, Palo Alto Firewall,
                    Fortigate Firewall, F5 Load Balancer and Cisco SD-WAN training
                    with enterprise practical labs, certification guidance and
                    placement support, led by Nazeer Basha, a Senior Enterprise
                    Network & Infrastructure Consultant with 14+ years of
                    experience. Training center hours are Monday to Saturday,
                    9:00 AM to 8:00 PM.
                </p>
            </section>
                ...
                <div className="relative z-10 mx-auto max-w-[1400px] px-5">
                    <div className="grid items-center gap-16 lg:grid-cols-[1fr_0.95fr]">
                        ...
                        <div>
                            ...
                            <h1 className="mt-8 text-[46px] font-black leading-[0.95] tracking-[-0.05em] text-white md:text-[72px] xl:text-[92px]">
                            ...
                            <p className="mt-8 max-w-[780px] text-[18px] leading-[1.9] text-white/60">
                            ...
                            {/* RELATED COURSES — styled, crawlable internal links */}
                            <div className="mt-6 flex flex-wrap gap-3">
                                {relatedCourses.map((c) => (
                                    ...
                                    >
                                        {c.title}
                                        <ArrowUpRight
                                            className="h-3.5 w-3.5 opacity-0 -translate-x-1 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100"
                                            aria-hidden="true"
                                        />
                                    </Link>
                                ))}
                            ...
                            {/* INFO GRID — with itemProp microdata for local SEO */}
                            <div
                                className="mt-12 grid gap-5 md:grid-cols-2"
                                itemScope
                                itemType="https://schema.org/EducationalOrganization"
                            >
                                <meta itemProp="name" content="NG Cloud Networks" />
                                ...
                                <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-xl">
                                    ...
                                    <p
                                        className="mt-3 text-[16px] text-white/60"
                                        itemProp="telephone"
                                    >
                                        +91 9989939191
                                    </p>
                                ...
                                <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-xl">
                                    ...
                                    <p
                                        className="mt-3 text-[16px] text-white/60 break-all"
                                        itemProp="email"
                                    >
                        ...
                        <div className="relative overflow-hidden rounded-[40px] border border-white/10 bg-white/[0.03] p-8 backdrop-blur-2xl lg:p-10">
                            ...
                            <div className="relative z-10">
                                ...
                                <h2 className="mt-8 text-[38px] font-black leading-[1] tracking-[-0.04em] text-white">
                                    Send Us Your
                                    <span className="block text-[#D4AF37]">Enquiry</span>
                                </h2>
                                ...
                                <form onSubmit={handleSubmit} className="mt-10 space-y-5">
                                    <div className="grid gap-5 md:grid-cols-2">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="h-[58px] w-full rounded-2xl border border-white/10 bg-black/20 px-5 text-white outline-none transition-all duration-300 placeholder:text-white/35 focus:border-[#D4AF37]/40"
                                            />
                                        </div>
                                    ...
                                    <select
                                        ...
                                        className="h-[58px] w-full appearance-none rounded-2xl border border-white/10 bg-[#0d0d0d] px-5 text-[15px] font-medium text-white outline-none transition-all duration-300 focus:border-[#D4AF37]/50 focus:bg-[#111111] focus:shadow-[0_0_0_4px_rgba(212,175,55,0.08)]"
                                    >
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-2xl border border-white/10 bg-black/20 px-5 py-4 text-white outline-none transition-all duration-300 placeholder:text-white/35 focus:border-[#D4AF37]/40"
                                    />

                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="group flex h-[58px] w-full items-center justify-center gap-3 rounded-2xl bg-[#D4AF37] text-[15px] font-semibold text-black transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_0_35px_rgba(212,175,55,0.35)] disabled:opacity-70"
                                    >
            ...
            <section className="relative overflow-hidden py-24">
                <div className="mx-auto max-w-[1400px] px-5">
                    <div className="relative overflow-hidden rounded-[40px] border border-[#D4AF37]/20 bg-[#D4AF37]/5 p-10 backdrop-blur-2xl lg:p-16">
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="mt-8 max-w-[900px] text-[42px] font-black leading-[1] tracking-[-0.04em] text-white md:text-[68px]">
                            ...
                            <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                                {[
                                    ...
                                    <div key={index} className="rounded-[28px] border border-white/10 bg-black/20 p-6">
                                        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#D4AF37]/10">
